	...
	metaLines.push(
		...
		...(nodeDescription.options ?? []).map((option) => {
			if (option.enumOptions) {
				...
				const displayName = Object.hasOwn(option, "displayName") ? ` displayName="${option.displayName}"` : ""

				let enumLines = [`\t\t\t\t<ci:enumOption${selectNone}${displayName}>`]
